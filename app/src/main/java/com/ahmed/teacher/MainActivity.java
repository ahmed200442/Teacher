...
public class MainActivity extends Activity {
 ...
 @Override protected void onActivityResult(int r,int c,Intent d){super.onActivityResult(r,c,d);if(r==101&&c==RESULT_OK&&d!=null){Uri u=d.getData();try{names=ExcelReader.readNames(this,u);saveNames();Toast.makeText(this,"تم استيراد "+names.size()+" اسمًا وحفظهم للفصل",Toast.LENGTH_LONG).show();open(cls);}catch(Exception e){Toast.makeText(this,"تعذر قراءة الملف: "+e.getMessage(),Toast.LENGTH_LONG).show();}}}
